...
class _PreferencesScreenState extends State<PreferencesScreen> {
  ...
  final String uid = SharedResources.getCurrentUser().uid;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: SizedBox(
                width: MediaQuery.of(context).size.width * 0.9,
                child: viewModel.startAge != null && viewModel.endAge != null
                    ? Column(
                        mainAxisSize: MainAxisSize.min,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
            ...
            Align(
              ...
              child: Padding(
                ...
                child: MaterialButton(
                  onPressed: () async {
                    var response1 = await Provider.of<PreferencesViewModel>(
                            context,
                            listen: false)
                        .updateStartAge(uid, _currentRangeValues.start.toInt());
                    var response2 = await Provider.of<PreferencesViewModel>(
                            context,
                            listen: false)
                        .updateEndAge(uid, _currentRangeValues.end.toInt());
